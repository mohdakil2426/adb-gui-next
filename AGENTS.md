...
This project is indexed by GitNexus as **adb-gui-next** (6681 symbols, 11954 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
