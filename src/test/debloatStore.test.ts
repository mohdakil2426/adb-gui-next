...
describe("debloatStore", () => {
  ...
  describe("togglePackage", () => {
    it("should add package to selected", () => {
      ...
      expect(
        useDebloatStore.getState().selectedPackages.has("com.android.app1")
      ).toBe(true);
    });
    ...
    it("should not allow selecting Unsafe packages without expert mode", () => {
      ...
      expect(
        useDebloatStore.getState().selectedPackages.has("com.android.app3")
      ).toBe(false);
    });
  ...
  describe("setCurrentPackageName", () => {
    it("should set current package for description panel", () => {
      ...
      expect(useDebloatStore.getState().currentPackageName).toBe(
        "com.android.app1"
      );
    });
