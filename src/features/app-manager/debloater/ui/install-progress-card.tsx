...
const useElapsedSeconds = (startedAt: number): number => {
  ...
  return Math.floor((now - startedAt) / TICK_MS);
};
 ...
 */
export const InstallProgressCard = ({ flagsCount = 1, progress }: InstallProgressCardProps) => {
