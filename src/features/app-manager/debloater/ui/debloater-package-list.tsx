...
import { DebloaterPackageRow } from "./debloater-package-row";
import { DEBLOAT_ROW_HEIGHT, PACKAGE_LIST_VIEWPORT } from "./debloater-utils";
import { PackageListEmpty, PackageListSkeleton } from "./package-list-state";
...
export const DebloaterPackageList = ({
  currentPackageName,
  filteredPackages,
  flags,
  onClearFilters,
        ...
        <div className="flex items-center gap-2.5">
          {selectedPackages.size > 0 ? (
            <span className="numeric text-caption text-muted-foreground">
              ...
              {selectedPackages.size === 1 ? "" : "s"} queued
            </span>
          ) : null}
