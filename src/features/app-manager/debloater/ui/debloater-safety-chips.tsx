...
import type { RemovalFilter } from "@/features/app-manager/debloater/model/debloat-store";
import { cn } from "@/shared/utils/cn";

import { SAFETY_CHIP_DEFS } from "./debloater-constants";
...
export const DebloaterSafetyChips = ({
