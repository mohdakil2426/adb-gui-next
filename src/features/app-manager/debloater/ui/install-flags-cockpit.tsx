...
import { INSTALL_FLAGS_CATALOG } from "@/features/app-manager/debloater/model/install-flags";
import {
 ...
 */
export const InstallFlagsCockpit = ({ disabled = false }: InstallFlagsCockpitProps) => {
