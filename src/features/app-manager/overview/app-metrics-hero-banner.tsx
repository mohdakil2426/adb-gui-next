...
import type { PackageOverviewStats } from "@/features/app-manager/model/package-stats";
...
export const AppMetricsHeroBanner = ({ stats }: AppMetricsHeroBannerProps) => {
        ...
        return (
          <m.div
            ...
            transition={
              shouldReduceMotion
                ? { duration: 0 }
                : { delay: index * 0.05, duration: 0.32, ease: EASE_STANDARD }
            }
          >
