...
import { useInstalledPackages } from "@/features/app-manager/debloater/hooks/use-installed-packages";
import { useDebloatStore } from "@/features/app-manager/debloater/model/debloat-store";
import type { AppManagerTab } from "@/features/app-manager/debloater/model/debloat-store";
...
import { InstallationTab } from "@/features/app-manager/debloater/ui/installation-tab";
import { InstalledAppsTab } from "@/features/app-manager/debloater/ui/installed-apps-tab";
import { PackageInspectorDrawer } from "@/features/app-manager/inspector/package-inspector-drawer";
import { AppOverviewTab } from "@/features/app-manager/overview/app-overview-tab";
import { Card, CardContent } from "@/shared/ui/card";
import { Tabs, TabsList, TabsTrigger } from "@/shared/ui/tabs";

export const AppManagerView = ({ activeView }: { activeView: string }) => {
