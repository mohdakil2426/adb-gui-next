...
const DeviceTile = ({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex w-full cursor-pointer select-none flex-col justify-between gap-3 rounded-lg border p-3.5 text-left transition-colors duration-100 ease-standard",
        isSelected
...
export const TargetDeviceSelector = ({
  activeSerials,
  disabled,
  onClearAll,
  onSelectAll,
