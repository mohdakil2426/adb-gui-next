...
import { QUALITY_PRESETS } from "@/features/scrcpy/model/defaults";
import type { QualityPreset } from "@/features/scrcpy/model/defaults";
...
export const QualityPresetsCard = ({ onApplyPreset, options }: QualityPresetsCardProps) => {
