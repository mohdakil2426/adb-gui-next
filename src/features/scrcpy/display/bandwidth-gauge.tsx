...
export const BandwidthGauge = ({ bitrateStr }: BandwidthGaugeProps) => {
  ...
  const ratingColor =
    metrics?.ratingColor === "emerald" || bitrateMbps <= 4
      ? "text-muted-foreground"
      : "text-foreground";

  const mbPerMin =
    metrics?.mbPerMin === null || metrics?.mbPerMin === undefined
