...
import { COMMON_PARTITIONS } from "@/features/flasher/model/flasher-constants";
import { PartitionInspectionBadge } from "@/features/flasher/partition/partition-inspection-badge";
import { PartitionSelectorChips } from "@/features/flasher/partition/partition-selector-chips";
import { DropArea } from "@/features/flasher/ui/drop-area";
import { isHighRiskPartition } from "@/features/flasher/utils/flasher-risk";
...
const PartitionFlashFooter = ({
  ...
  <CardFooter className="flex items-center justify-between border-border border-t pt-4">
    ...
    <Button
      ...
      disabled={
        isGlobalLoading || isBatchFlashing || !selectedFastbootSerial || !partition || !filePath
      }
...
export const PartitionFlashCard = ({
  partition,
  setPartition,
  filePath,
  setFilePath,
