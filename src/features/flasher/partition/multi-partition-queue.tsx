...
const ITEM_STATUS_STYLES: Record<string, string> = {
  ...
  flashing: "border-primary/50 bg-primary/5",
  success: "border-success/30 bg-success/5",
};

const ITEM_STATUS_VARIANTS: Record<string, "success" | "destructive" | "default" | "outline"> = {
  failed: "destructive",
  flashing: "default",
  success: "success",
};

export const MultiPartitionQueue = ({
  queue,
  isBatchFlashing,
  currentIndex,
  onRemoveItem,
            ...
            {queue.map((item, idx) => (
              <div
                className={cn(
                  ...
                  ITEM_STATUS_STYLES[item.status] ?? "border-border/70 bg-surface-raised/40"
                )}
                key={item.id}
              >
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <Badge
                    ...
                    variant={ITEM_STATUS_VARIANTS[item.status] ?? "outline"}
                  >
