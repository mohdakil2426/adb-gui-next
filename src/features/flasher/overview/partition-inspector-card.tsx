...
import { PARTITION_METADATA } from "@/features/flasher/model/flasher-constants";
...
const RISK_BADGE_VARIANT: Record<string, "destructive" | "default" | "outline"> = {
  critical: "destructive",
  elevated: "default",
};

export const PartitionInspectorCard = ({
  onSelectPartition,
  selectedPartition,
    ...
    <div className="flex flex-col gap-3 rounded-lg border border-border/80 bg-surface-raised/40 p-3.5">
      <div className="flex flex-wrap items-center justify-between gap-2 border-border/50 border-b pb-2">
        <div className="flex items-center gap-2">
          ...
          <Badge className="text-[10px]" variant={RISK_BADGE_VARIANT[meta.riskLevel] ?? "outline"}>
