import type { DiagnosticItem, FastbootVitals } from "@/features/flasher/model/flasher-types";
import { FlashAuditLogCard } from "@/features/flasher/overview/flash-audit-log-card";
import { FlasherKnowledgeBase } from "@/features/flasher/overview/flasher-knowledge-base";
import { PartitionHierarchyDiagram } from "@/features/flasher/overview/partition-hierarchy-diagram";
import { PreFlightDiagnosticMatrix } from "@/features/flasher/overview/pre-flight-diagnostic-matrix";
...
export const FlasherOverviewTab = ({
  vitals,
  diagnostics,
  isProbing,
  onRefresh,
