...
import { PartitionHierarchySvg } from "@/features/flasher/overview/partition-hierarchy-svg";
import { PartitionInspectorCard } from "@/features/flasher/overview/partition-inspector-card";
...
export const PartitionHierarchyDiagram = ({ activeSlot }: PartitionHierarchyDiagramProps) => {
