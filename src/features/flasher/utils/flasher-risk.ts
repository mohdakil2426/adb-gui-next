...
const SLOT_SUFFIX = /_[ab]$/u;

export const normalizePartition = (name: string): string =>
  name.trim().toLowerCase().replace(SLOT_SUFFIX, "");

export const isHighRiskPartition = (name: string): boolean => {
