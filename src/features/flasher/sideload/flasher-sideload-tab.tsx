...
import { SideloadHelperActions } from "@/features/flasher/sideload/sideload-helper-actions";
import { SideloadProgressCard } from "@/features/flasher/sideload/sideload-progress-card";
...
export const FlasherSideloadTab = ({
  sideloadFilePath,
  setSideloadFilePath,
  isGlobalLoading,
  loadingAction,
