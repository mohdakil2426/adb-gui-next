...
export const ScreenshotStudioCard = ({ deviceMode, deviceSerial }: ScreenshotStudioCardProps) => {
  ...
  const handleCaptureScreenshot = async () => {
    ...
    try {
      ...
      const cleanBase64 = rawBase64.replaceAll(/\s+/gu, "");
          ...
          {screenshotBase64 ? (
            <>
              ...
              <Button
                className="h-8 gap-1.5 px-3 text-caption"
                onClick={() => {
                  void handleSaveScreenshotToDisk();
                }}
                size="sm"
                type="button"
                variant="outline"
