import { FastbootGetVarCard } from "@/features/utilities/fastboot/fastboot-get-var-card";
import { FastbootSlotControlCard } from "@/features/utilities/fastboot/fastboot-slot-control-card";
...
export const UtilitiesFastbootTab = ({
  deviceMode,
  deviceSerial,
  handleReboot,
  handleSetActiveSlot,
