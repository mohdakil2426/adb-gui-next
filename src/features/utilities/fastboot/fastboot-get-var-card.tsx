...
export const FastbootGetVarCard = ({ deviceMode, deviceSerial }: FastbootGetVarCardProps) => {
  ...
  const handleExportJson = async () => {
    ...
    try {
      ...
      for (const r of parsedVariables) {
        obj[r.key] = r.value;
      }
