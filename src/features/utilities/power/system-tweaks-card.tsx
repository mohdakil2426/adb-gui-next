...
export const SystemTweaksCard = ({ deviceMode, deviceSerial }: SystemTweaksCardProps) => {
            ...
            <div className="flex items-center gap-2">
              {["0.0", "0.5", "1.0", "1.5"].map((scale) => (
                <Button
                  ...
                  key={scale}
                  onClick={() => {
                    void handleSetAnimationScale(scale);
                  }}
                  size="sm"
                  type="button"
