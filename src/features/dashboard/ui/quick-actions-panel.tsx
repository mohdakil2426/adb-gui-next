import { Monitor, Power, RotateCcw, Terminal, Wrench, Zap } from "lucide-react";
...
import type { DeviceMode } from "@/features/dashboard/model/device-mode";
...
export const QuickActionsPanel = ({
  ...
  const handleMirror = async () => {
    ...
    try {
      ...
      toast.success("Launched Scrcpy Mirror", {
        description: `Target: ${serial}`,
      });
    } catch (error) {
