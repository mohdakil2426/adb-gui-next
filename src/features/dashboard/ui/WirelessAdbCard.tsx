      ...
      <CardContent className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
        <div className="flex flex-col gap-3">
          ...
          <Button
            ...
            disabled={isEnablingTcpip || !selectedSerial || isConnecting || deviceMode !== 'adb'}
        ...
        <div className="flex flex-col gap-3">
          ...
          <form className="flex flex-col gap-3" onSubmit={wirelessForm.handleSubmit(handleConnect)}>
            <FieldGroup>
              <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_6rem]">
                ...
                <Field data-invalid={Boolean(wirelessForm.formState.errors.port)}>
                  ...
                  <Input
                    aria-describedby={wirelessForm.formState.errors.port ? 'port-error' : undefined}
