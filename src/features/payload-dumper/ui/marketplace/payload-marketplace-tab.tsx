...
import { FirmwareDeviceDetailView } from "@/features/payload-dumper/ui/marketplace/firmware-device-detail-view";
import { PayloadMarketplaceDeviceGrid } from "@/features/payload-dumper/ui/marketplace/payload-marketplace-device-grid";
import { PayloadMarketplaceFilterBar } from "@/features/payload-dumper/ui/marketplace/payload-marketplace-filter-bar";
import { BRAND_DISPLAY_INFO } from "@/features/payload-dumper/ui/marketplace/types";
import type {
  BrandFilter,
  FirmwareDeviceModel,
} from "@/features/payload-dumper/ui/marketplace/types";
import { useFirmwareCatalog } from "@/features/payload-dumper/ui/marketplace/use-firmware-catalog";
...
export const PayloadMarketplaceTab = ({ onSelectRemoteUrl }: PayloadMarketplaceTabProps) => {
  ...
  const brandChips = useMemo(() => {
    const chips: { id: BrandFilter; label: string }[] = [{ id: "all", label: "All" }];
