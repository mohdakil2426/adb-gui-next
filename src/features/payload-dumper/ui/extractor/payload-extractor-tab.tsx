...
import type { PartitionProgress } from "@/features/payload-dumper/model/payload-progress-store";
import { ActionFooter } from "@/features/payload-dumper/ui/action-footer";
import type { CategoryFilterType } from "@/features/payload-dumper/ui/extractor/partition-category-filter";
import { PartitionTableList } from "@/features/payload-dumper/ui/extractor/partition-table-list";
import { PartitionToolbar } from "@/features/payload-dumper/ui/extractor/partition-toolbar";
import { LoadingState } from "@/features/payload-dumper/ui/loading-state";
import { OutputDirectoryField } from "@/features/payload-dumper/ui/output-directory-field";
import { PayloadSourceTabs } from "@/features/payload-dumper/ui/payload-source-tabs";
import { getPartitionCategory } from "@/features/payload-dumper/utils/partition-categories";
...
export const PayloadExtractorTab = ({
  partitions,
  completedPartitions,
  partitionProgress,
  partitionStatuses,
