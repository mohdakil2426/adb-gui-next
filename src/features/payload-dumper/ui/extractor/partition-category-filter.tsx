...
} from "@/features/payload-dumper/utils/partition-categories";
import type { PartitionCategory } from "@/features/payload-dumper/utils/partition-categories";
...
export const PartitionCategoryFilter = ({
  partitions,
  activeCategory,
  onSelectCategory,
