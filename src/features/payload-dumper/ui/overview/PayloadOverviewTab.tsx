  ...
  return (
    <div className="@container flex flex-col gap-5">
      ...
      <div>
        ...
        <div className="grid @lg:grid-cols-3 grid-cols-1 gap-3.5">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-caption text-muted-foreground leading-relaxed">
                    Load local OTA packages (<code className="text-[11px]">payload.bin</code>, ZIP)
                    or stream directly from vendor OTA download links.
                  </p>
                </div>
              </div>
