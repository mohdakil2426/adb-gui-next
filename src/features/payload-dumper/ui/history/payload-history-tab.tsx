...
import { HistoryRecordCard } from "@/features/payload-dumper/ui/history/history-record-card";
...
export const PayloadHistoryTab = ({
  history,
  extractedFiles,
  outputDir,
  onClearHistory,
  ...
  const effectiveHistory = useMemo(() => {
    ...
    return [];
  }, [history, extractedFiles, outputDir, sessionTimestamp]);
