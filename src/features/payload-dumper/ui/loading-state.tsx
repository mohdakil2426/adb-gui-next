 ...
 */
const getLoadingMessage = (mode: "local" | "remote", path: string): string => {
  if (mode === "remote") {
...
export const LoadingState = ({ mode, remoteUrl, payloadPath }: LoadingStateProps) => {
  const message = getLoadingMessage(mode, payloadPath);
