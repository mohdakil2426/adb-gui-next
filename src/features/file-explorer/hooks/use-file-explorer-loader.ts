...
import { MAX_HISTORY } from "@/features/file-explorer/model/file-explorer-constants";
import type { FileEntry, LoadError } from "@/features/file-explorer/model/file-explorer-types";
...
export const useFileExplorerLoader = (options: Options) => {
  const {
    categorizeError,
    currentPathRef,
    getFileAccessMode,
