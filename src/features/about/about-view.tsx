...
import { usePlatformToolVersions } from "@/features/about/hooks/use-platform-tool-versions";
import {
  APP_COPYRIGHT,
  APP_LICENSE,
  APP_NAME,
  ...
  RELEASES_URL,
  REPOSITORY_URL,
} from "@/features/about/model/app-info";
import { AboutCard } from "@/features/about/ui/about-card";
import { ExternalLinkButton } from "@/features/about/ui/external-link-button";
