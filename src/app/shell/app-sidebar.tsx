...
import { VIEW_PRELOADERS, VIEWS } from "@/app/shell/view-config";
...
import { useViewActivityCount } from "@/shared/stores/operation-store";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
 ...
 */
const SidebarDeviceCard = ({ onOpenDevicePicker }: SidebarDeviceCardProps) => {
...
const NavActivityBadge = ({ view }: { view: ViewType }) => {
...
const NavButton = ({ activeView, onViewChange, view }: NavButtonProps) => {
