...
import { LoadingScreen } from "@/app/shell/loading-screen";
import { StatusBar } from "@/app/shell/status-bar";
import type { AdbServerState } from "@/app/shell/status-bar";
import { VIEW_RENDERERS, VIEWS } from "@/app/shell/view-config";
import type { ViewType } from "@/app/shell/view-config";
import { ViewContent } from "@/app/shell/view-content";
import { LaunchDeviceManager, LaunchTerminal } from "@/desktop/backend";
import { ErrorBoundary } from "@/shared/components/error-boundary";
import { UnreadLogAnnouncer } from "@/shared/components/unread-log-badge";
import { useAppReady } from "@/shared/hooks/use-app-ready";
import { useGlobalShortcuts } from "@/shared/hooks/use-global-shortcuts";
import { usePersistedActiveView } from "@/shared/hooks/use-persisted-active-view";
...
const resolveAdbState = (isError: boolean, isPending: boolean): AdbServerState => {
  if (isError) {
    return "unreachable";
  }
  if (isPending) {
