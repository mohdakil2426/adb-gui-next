...
import { LogRow } from "@/app/shell/BottomPanel/log-row";
...
const escapeRegExp = (value: string): string => value.replace(REGEX_ESCAPE, "\\$&");
...
export const LogsPanel = memo(function LogsPanel() {
  ...
  const searchRegex = useMemo(
    () => (searchQuery ? new RegExp(escapeRegExp(searchQuery), "giu") : null),
    [searchQuery]
  );
