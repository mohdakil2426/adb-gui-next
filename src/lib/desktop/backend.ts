...
export function DiagnosePayload(
  path: string
): Promise<backend.PayloadDiagnostics> {
...
export function DisconnectWirelessAdb(
  ip: string,
  port: string
): Promise<string> {
...
export function EnableWirelessAdb(
  port: string,
  serial?: string | null
): Promise<string> {
...
export function GetInstalledPackages(
  serial?: string | null
): Promise<backend.InstalledPackage[]> {
...
export function RunFastbootHostCommand(
  command: string,
  serial?: string | null
): Promise<string> {
...
export function SideloadPackage(
  path: string,
  serial?: string | null
): Promise<string> {
...
export function RootAvd(
  request: backend.RootAvdRequest
): Promise<backend.RootAvdResult> {
 ...
 */
export function CheckRemotePayload(
  url: string
): Promise<backend.RemotePayloadInfo> {
 ...
 */
export function ListRemotePayloadPartitions(
  url: string
): Promise<backend.PartitionDetail[]> {
 ...
 */
export function GetRemotePayloadMetadata(
  url: string
): Promise<backend.RemotePayloadMetadata> {
