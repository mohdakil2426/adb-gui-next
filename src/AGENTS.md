...
| Payload Dumper | 4-tab Hardware Cockpit (Overview, Source & Remote Loader, Extractor & Partitions, Extracted Outputs & History); `PayloadDumperHeroBanner` with format detection & uncompressed footprint |
