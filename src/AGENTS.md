...
| Payload Dumper | 4-tab Hardware Cockpit (Overview, Extractor & Partitions, Source & Remote Loader, Extracted Outputs & History); `PayloadDumperHeroBanner` with format detection & uncompressed footprint |
