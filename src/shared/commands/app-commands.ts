...
import { AVAILABLE, blocked } from "@/shared/commands/types";
import type { CommandAction, CommandContext } from "@/shared/commands/types";
 ...
 */
export const viewCommands = (ctx: CommandContext): CommandAction[] =>
  NAV_VIEW_ORDER.map((view) => {
...
export const shellCommands = (ctx: CommandContext): CommandAction[] => {
