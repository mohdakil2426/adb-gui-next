...
- **Global scope**: `C:/Users/akila/OneDrive/Desktop/OSS/WindowsApps/adb-gui-next/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/akila/OneDrive/Desktop/OSS/WindowsApps/adb-gui-next/.claude/notes/`)
...
2. Glob `C:/Users/akila/OneDrive/Desktop/OSS/WindowsApps/adb-gui-next/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/akila/OneDrive/Desktop/OSS/WindowsApps/adb-gui-next/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/akila/OneDrive/Desktop/OSS/WindowsApps/adb-gui-next/.claude/notes/` — works in any directory
