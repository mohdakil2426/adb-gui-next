...
1. **Product goal:** Best-in-class _streaming OTA/factory_ remote dumper, or _any firmware URL → files_ (including full-download OPS/OFP)?
...
| Named stages            | User knows _what_ is slow                           |
