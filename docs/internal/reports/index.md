...
All former `docs/reports/active` and `docs/reports/closed` write-ups were migrated into `closed/YYYY-MM-DD/` with kebab-case names and category suffixes (2026-07-18).
